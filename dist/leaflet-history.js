...
!function(){
    L.HistoryControl=L.Control.extend({
        ...
        maxMovesToSave:10,useExternalControls:!1,
        backImage:"fa fa-caret-left fa-2x",
        backText:"",
        backTooltip:"Go to Previous Extent",
        backImageBeforeText:!0,
        forwardImage:"fa fa-caret-right fa-2x",
        forwardText:"",
    ...
    onAdd:function(a){
        ...
        return this.options.useExternalControls||(this._backButton=this._createButton("back",b,this.goBack,this),
        this._forwardButton=this._createButton("forward",b,this.goForward,this)),
        this._updateDisabled(),this._addMapListeners(),b},
    onRemove:function(a){
        a.off("movestart")},
    ...
    _updateDisabled:function(){
        ...
        a!==this._state.backDisabled&&(this._state.backDisabled=a,
            this._map.fire("historyback"+(a?"disabled":"enabled"))),
            b!==this._state.forwardDisabled&&(this._state.forwardDisabled=b,
                this._map.fire("historyforward"+(b?"disabled":"enabled"))),
                this.options.useExternalControls||(this._setButtonDisabled(this._backButton,a)
                ,this._setButtonDisabled(this._forwardButton,b))},
                _setButtonDisabled:function(a,b){var c="leaflet-disabled";
            b?L.DomUtil.addClass(a,c):L.DomUtil.removeClass(a,c)},_pop:function(a){
    ...
    _invokeBackOrForward:function(a,b,c){
        var d=this._popStackAndUseLocation(b,c);return d?(this._map.fire(a,d),!0):!1},
    _popStackAndUseLocation:function(a,b){
        if(L.Util.isArray(a.items)&&a.items.length>0){
            ...
            d=this._pop(a);return this._push(b,c),
            this.moveWithoutTriggeringEvent(d),{previousLocation:d,currentLocation:c}}},
    _buildZoomCenterObjectFromCurrent:function(a){
        return new L.ZoomCenter(a.getZoom(),a.getCenter())},
    _addMapListeners:function(){
        var a=this;this._map.on("movestart",function(b){
            if(a._state.ignoringEvents)a._state.ignoringEvents=!1;
            else{var c=a._buildZoomCenterObjectFromCurrent(b.target);
            a.options.shouldSaveMoveInHistory(c)&&(a._state.future.items=[],
                a._push(a._state.history,c))}a._updateDisabled()})}})}(),
    function(){
